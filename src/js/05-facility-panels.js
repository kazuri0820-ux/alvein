...
function renderVolunteers(){
  ...
  for(const v of list){
    ...
    h+=`<div class="pcard${rank.label==="Z"?" mat-awakened-glow":""}" style="border-color:${rank.color};border-width:${rankStyle.bw};box-shadow:${rankStyle.glow};background:${rankStyle.bg};${muted}">
      ...
      <div class="ds">${race.name}・${origin?origin.name:""}・${u.personality} ／ ${JOB_TREES[u.cls].label}志望</div>
    ...
    for(const u of S.instructors){
      ...
      h+=`<div class="ucard mat-${acc.material}" data-uid="${u.id}" style="opacity:.88;cursor:pointer;--m-tone:${cc}">
        ...
        <div class="ubody">
          ...
          <div class="usub" style="margin-top:6px"><span>${JOB_TREES[u.cls].label}出身・教官(元Lv.${u.lv})</span></div>
        </div>
      </div>`;
    }
  }
